    ...
    <main>
      <section class="panel">
        <div class="container1">
          ...
          <a href="other/form/form1.php">
            <div class="box01">
              <img src="img/img20.png" alt="Form 1" class="image01">
              <h3>Form 1</h3>
            </div>
          </a>
          <a href="other/form/form2.php">
            <div class="box01">
              <img src="img/2.jpg" alt="Form 2" class="image01">
                <h3>Form 2</h3>
            </div>
          </a>
          <a href="other/form/form3.php">
            <div class="box01">
              <img src="img/03.png" alt="Form 3" class="image01">
              <h3>Form 3</h3>
            </div>
          </a>
          <a href="other/form/form4.php">
            <div class="box01">
              <img src="img/img24.jpg" alt="Form 4" class="image01">
              <h3>Form 4</h3>
            </div>
          </a>
          </section>
